...
public class HelloWorld {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String remotePath = fileSeparator + "proxy" + fileSeparator + "ceshi" + fileSeparator + "stt" + fileSeparator;
			...
			/*
			 * if(download(localFile,remoteFile)){
			 * System.out.println("下载成功01");
			 * }
