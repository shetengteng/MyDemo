package com.stt.NetWorkDemo.part11_RMI.test02_FlightFactory.client;
...
import com.stt.NetWorkDemo.part11_RMI.test02_FlightFactory.service.Flight;
import com.stt.NetWorkDemo.part11_RMI.test02_FlightFactory.service.FlightFactory;
...
public class SimpleClient {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(flight02.getFligthNo());
