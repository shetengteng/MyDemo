...
public class HttpsClient {
	...
	public String sengMessage(String message) throws Exception {
		...
		// 取出返回内容
		if (entity != null) {
			BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(entity.getContent(), "gb18030"));
			String lineMessage;
	...
	public String sengMessage2(String message) throws Exception {
		HttpClient httpClient = new DefaultHttpClient();
		// 密钥管理器
		KeyStore keyStore = KeyStore.getInstance(sslKeyStoreType);
		// 信任管理器
