...
public final class HttpClientUtils {
	...
	public static String send(final Method method, final String url, final Map<String, String> headers,
		...
		if (entity == null)
			...
			return send(method, url, headers, entity, nameValuePairs, useURLEncoder, encodeCharset,
					stringResponseHandler, null, config);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		// String resultMsg = HttpClientUtils.send(Method.POST, uri + "/" +
		// prop.getProperty("apiName"), msg, true, CmbcConstants.ENCODING_UTF8,
		// 3 * 60 * 1000);
		...
		String resultMsg = HttpClientUtils.send(Method.POST, uri, null, null, nameValuePairs, true, "GBK",
				stringResponseHandler, null, requestConfig);
