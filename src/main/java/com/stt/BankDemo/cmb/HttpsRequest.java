			...
			if (pktRsp != null) {
				if (pktRsp.isError()) {
					...
					for (int i = 0; i < size; i++) {
						...
						System.out.println("交易日:" + propDtl.get("ETYDAT") + " 交易时间:" + propDtl.get("ETYTIM") + " 流程实例号:"
								+ propDtl.get("REQNBR") + " 对方账号:" + propDtl.get("RPYACC") + " 借方金额:"
								+ propDtl.get("TRSAMTD") + " 贷方金额:" + propDtl.get("TRSAMTC"));
					}
				}
			} else {
